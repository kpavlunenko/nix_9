...
public class AgreementFacadeImpl implements AgreementFacade {
    ...
    public void create(AgreementRequestDto agreementRequestDto) {
        ...
        agreement.setCompany(companyService.findById(agreementRequestDto.getCompanyId()).get());
        agreement.setCounterparty(counterpartyService.findById(agreementRequestDto.getCounterpartyId()).get());
    ...
    public AgreementResponseDto findById(Long id) {
        return new AgreementResponseDto(agreementService.findById(id).get());
    }
